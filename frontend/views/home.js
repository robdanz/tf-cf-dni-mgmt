  ...
  return `
    <div class="card">
      ...
      <p style="color: #666; line-height: 1.6;">
        CF1 Cockpit provides visual utilities for the Cloudflare One environment.
        Use the sidebar to explore analytics, reports, and admin tools.
      </p>
      <div style="margin-top: 1.5rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
        ...
        <div style="padding: 1rem; background: #f8f9fa; border-radius: 8px; text-align: center;">
          ...
          <div style="font-weight: 600;">Admin Tools</div>
          <div style="font-size: 0.9rem; color: #666;">TLS Auto Pilot list manager</div>
        </div>
      </div>
    </div>
  `;
